...
func testClientMerkleVerficationUploadFail(t *testing.T, grpcClient api.MerkleTreeClient) {
	...
	expectedResp := &api.UploadResponse{
		MerkleRootHash: []byte("50a504831bd50fee3581d287168a85a8dcdd6aa777ffd0fe35e37290268a0155"),
	}
	...
	require.NoError(t, err)
	require.NotEqual(t, expectedResp.MerkleRootHash, uploadResp.MerkleRootHash)
}
